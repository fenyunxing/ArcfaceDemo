...
public class Constants {
    ...
    public static final String APP_ID = "FcKhgA5fKrLQ5EyeMu5gYqU8F7oBbBTQrMCFX32KVGoe";
    public static final String SDK_KEY = "DdiBV2RxBwcuqqToSPGJHVxFccd3DTsq5QL85aehZUGV";
